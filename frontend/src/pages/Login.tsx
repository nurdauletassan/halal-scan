          ...
          <CardHeader className="bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 text-white relative overflow-hidden">
            ...
            <div className="relative">
              <CardTitle className="text-3xl text-center font-bold flex items-center justify-center">
                <Lock className="mr-3 h-6 w-6 my-3" />Вход в систему
              </CardTitle>
              <p className="text-center text-green-100 mt-2">Получите доступ к персональным функциям</p>
            </div>
          </CardHeader>
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  ...
                  />
                  <span className="ml-2 text-base text-gray-600">Запомнить меня</span>
                </label>
              ...
              {/* Removed social login buttons from the form */}
            </form>
